...
- Wait-closed loop (measure → act → measure): `lineage_loop_v2.py`
- Bind (real stages, measured service, executable levers): `lineage_bind_v2.py`
- Example records: `example_telemetry.json`, `minimal_telemetry.json`
- Replay windows for the loop: `hot_windows.jsonl`
...
- Closed-loop paper: `../LINEAGE_CLOSED_LOOP.md`
- Bind paper: `../LINEAGE_BIND.md`
...
python3 lineage_loop_v2.py
python3 lineage_bind_v2.py
python3 lineage_capacity_v2.py
python3 lineage_slice_v2.py --example
python3 lineage_geometry_v2.py
```

Expect `use_checks_passed 34`, `core_checks_passed 19`, `ops_checks_passed 16`, `control_checks_passed 12`, `network_checks_passed 14`, `qos_checks_passed 19`, `traffic_checks_passed 24`, `sim_checks_passed 8`, `loop_checks_passed 24`, `bind_checks_passed 25`, `all_validation_checks_passed 20`, `slice_validation_checks_passed 31`, and `geometry_validation_checks_passed 17`.
